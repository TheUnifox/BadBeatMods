...
export class BeatModsRoutes {
    ...
    private async loadRoutes() {
        this.app.get([`/api/beatmods/mod`, `/api/v1/mod`], async (req, res) => {
            // #swagger.auto = false
            // #swagger.path = '/api/beatmods/mod'
            // #swagger.method = 'put'
        ...
        this.app.get([`/api/beatmods/versions`, `/versions.json`], async (req, res) => {
            // #swagger.auto = false
            // #swagger.path = '/api/beatmods/versions'
            // #swagger.method = 'get'
            // #swagger.tags = ['BeatMods']
        ...
        this.app.get([`/api/beatmods/aliases`, `/aliases.json`], async (req, res) => {
            // #swagger.auto = false
            // #swagger.path = '/api/beatmods/aliases'
            // #swagger.method = 'get'
            // #swagger.tags = ['BeatMods']
