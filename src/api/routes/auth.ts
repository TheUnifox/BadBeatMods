...
export class AuthRoutes {
    ...
    private async loadRoutes() {
        this.router.get(`/api/auth`, async (req, res) => {
            // #swagger.tags = ['Auth']
        ...
        this.router.get(`/api/auth/logout`, async (req, res) => {
            // #swagger.tags = ['Auth']
        ...
        this.router.get(`/api/auth/github`, async (req, res) => {
            // #swagger.tags = ['Auth']
        ...
        this.router.get(`/api/auth/github/callback`, async (req, res) => {
            // #swagger.tags = ['Auth']
        ...
        this.router.get(`/api/link/discord`, async (req, res) => {
            // #swagger.tags = ['Auth']
            let session = await validateSession(req, res, false);
            if (!session.approved) {
                return;
        ...
        this.router.get(`/api/link/discord/callback`, async (req, res) => {
            // #swagger.tags = ['Auth']
            let reqQuery = Validator.zOAuth2Callback.safeParse(req.query);
            if (!reqQuery.success) {
                return res.status(400).send({ error: `Invalid parameters.` });
